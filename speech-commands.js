...
! function(e, t) {
    ...
    function c(e) {
        return null == u && (u = t.backend().epsilon()), t.tidy(function() {
            var r = t.moments(e),
                n = r.mean,
                a = r.variance;
            return e.sub(n).div(a.sqrt().add(u))
        })
    }
    var h = function() {
        function e(e) {
        ...
        return e.prototype.start = function(e) {
            ...
            return a(this, void 0, void 0, function() {
                ...
                return i(this, function(i) {
                    switch (i.label) {
                        case 0:
                            return this.analyser.getFloatFrequencyData(this.freqData), this.freqData[0] === -1 / 0 ? [2] : (this.freqDataQueue.push(this.freqData.slice(0, this.columnTruncateLength)), this.includeRawAudio && (this.analyser.getFloatTimeDomainData(this.timeData), this.timeDataQueue.push(this.timeData.slice())), this.freqDataQueue.length > this.numFrames && this.freqDataQueue.shift(), this.tracker.tick() ? (e = d(this.freqDataQueue), r = p(e, [1, this.numFrames, this.columnTruncateLength, 1]), n = void 0, this.includeRawAudio && (a = d(this.timeDataQueue), n = p(a, [1, this.numFrames * this.fftSize])), [4, this.spectrogramCallback(r, n)]) : [3, 2]);
                        case 1:
    ...
    var b = "TFJSSCDS",
        ...
        x = function() {
            function e(e) {
                if (this.examples = {}, this.label2Ids = {}, null != e)
                    for (var r = function(e) {
                            ...
                            var r = 0,
                                n = y(e.slice(r, b.length));
                            t.util.assert(n === b, function() {
            ...
            return e.prototype.addExample = function(e) {
                ...
                1 === l.length ? (i = null == r.numFrames ? l[0] : r.numFrames, o = null == r.hopFrames ? 1 : r.hopFrames) : (i = r.numFrames, t.util.assert(null != i && Number.isInteger(i) && i > 0, function() {
                ...
                }), o = r.hopFrames, t.util.assert(null != o && Number.isInteger(o) && o > 0, function() {
                ...
                return t.tidy(function() {
                    for (var l, h, d, p = [], f = [], m = [], g = 0; g < a.length; ++g) {
                        ...
                        if (null == e || v === e) {
                            var y = n.label2Ids[v],
                                b = function(a) {
                                    var l, h, y = n.examples[a].spectrogram,
                                        b = y.frameSize;
                    ...
                    if (r.getDataset) {
                        var E = null == r.datasetBatchSize ? 32 : r.datasetBatchSize,
                            F = null == r.datasetValidationSplit ? .15 : r.datasetValidationSplit;
                        ...
                        var D = z.map(function(e) {
                            ...
                            I = function(e, r, n) {
                                ...
                                if (p) {
                                    ...
                                    try {
                                        for (var A = s(w), R = A.next(); !R.done; R = A.next()) L = R.value, M.push(e[L]), z.push(r[L])
                                    } catch (e) {
                                        o = {
                                            error: e
                                        }
                                ...
                                T = [], F = [], M = [], z = [];
                                try {
                                    for (var O = s(b), C = O.next(); !C.done; C = O.next()) L = C.value, T.push(e[L]), F.push(r[L])
                                } catch (e) {
                                    u = {
                                        error: e
                                    }
                                ...
                                try {
                                    for (var k = s(w), _ = k.next(); !_.done; _ = k.next()) L = _.value, M.push(e[L]), z.push(r[L])
                                } catch (e) {
                                    h = {
                                        error: e
                                    }
                ...
                for (var o = e[0] instanceof Float32Array, u = this.getVocabulary(), h = [], d = [], p = 0; p < r.length; ++p) "_background_noise_" === u[r[p]] ? h.push(p) : d.push(p);
                ...
                var f = [],
                    ...
                    g = function(a) {
                        var i, s, l = h[(i = 0, s = h.length, Math.floor((s - i) * Math.random()) + i)],
                            ...
                            p = t.tidy(function() {
                                return c(u.add(d.mul(n)))
                            });
                        o ? f.push(p.dataSync()) : f.push(p), m.push(r[a])
                    };
                try {
                ...
                var r, n, a, i, o = this.getVocabulary();
    ...
    function S(e) {
        ...
        return t && (r.rawAudioNumSamples = e.rawAudio.data.length, r.rawAudioSampleRateHz = e.rawAudio.sampleRateHz, n = m([n, e.rawAudio.data.buffer])), {
            spec: r,
            data: n
        }
    }
    ...
    var A = function() {
            function e(r, n, a) {
                this.MODEL_URL_PREFIX = "https://storage.googleapis.com/tfjs-models/tfjs/speech-commands/v" + z.split(".").slice(0, 2).join(".") + "/browser_fft", this.SAMPLE_RATE_HZ = 44100, this.FFT_SIZE = 1024, this.DEFAULT_SUPPRESSION_TIME_MILLIS = 0, this.streaming = !1, this.transferRecognizers = {}, t.util.assert(null == n && null == a || null != n && null != a, function() {
                ...
                }), this.vocabulary = r, this.modelArtifactsOrURL = this.MODEL_URL_PREFIX + "/" + this.vocabulary + "/model.json", this.metadataOrURL = this.MODEL_URL_PREFIX + "/" + this.vocabulary + "/metadata.json") : (t.util.assert(null == r, function() {
            ...
            return e.prototype.listen = function(e, r) {
                        ...
                        switch (m.label) {
                            ...
                            case 1:
                                if (m.sent(), null == r && (r = {}), n = null == r.probabilityThreshold ? 0 : r.probabilityThreshold, r.includeEmbedding && (n = 0), t.util.assert(n >= 0 && n <= 1, function() {
                                    ...
                                    }), s = null != r.invokeCallbackOnNoiseAndUnknown && r.invokeCallbackOnNoiseAndUnknown, r.includeEmbedding && (s = !0), r.suppressionTimeMillis < 0) throw new Error("suppressionTimeMillis is expected to be >= 0, but got " + r.suppressionTimeMillis);
                                return u = null == r.overlapFactor ? .5 : r.overlapFactor, t.util.assert(u >= 0 && u < 1, function() {
                                    ...
                                    return a(f, void 0, void 0, function() {
                                        ...
                                        return i(this, function(i) {
                                            switch (i.label) {
                                                case 0:
                                                    return h = c(u), r.includeEmbedding ? [4, this.ensureModelWithEmbeddingOutputCreated()] : [3, 2];
                                                case 1:
                                                ...
                                                case 5:
                                                    return g = i.sent()[0], v = Math.max.apply(Math, l(f)), t.dispose([d, m, h]), v < n ? [2, !1] : [3, 6];
                                                case 6:
                                                    return y = void 0, r.includeSpectrogram ? (b = {}, [4, u.data()]) : [3, 8];
                                                case 7:
                                ...
                                }, p = null == r.suppressionTimeMillis ? this.DEFAULT_SUPPRESSION_TIME_MILLIS : r.suppressionTimeMillis, this.audioDataExtractor = new h({
                                    ...
                                    return a(this, void 0, void 0, function() {
                                        return i(this, function(t) {
                                            return [2, new Promise(function(t, r) {
                                                ...
                                                }) : r(new Error("Unsupported URL scheme in metadata URL: " + e + ". Supported schemes are: http://, https://, and (node.js-only) file://"))
                                            })]
                                        })
                                    })
                                }(this.metadataOrURL)];
                                ...
                                spectrogramCallback: function(r) {
                                    return a(e, void 0, void 0, function() {
                                        ...
                                        return i(this, function(i) {
                                            switch (i.label) {
                                                case 0:
                                                    return e = c(r), [4, this.audioDataExtractor.stop()];
                                                case 1:
                ...
                var r = new R(e, this.parameters, this.model);
                return this.transferRecognizers[e] = r, r
            }, e.prototype.freezeModel = function() {
                var e, t;
                try {
                    for (var r = s(this.model.layers), n = r.next(); !n.done; n = r.next()) {
                        n.value.trainable = !1
                    }
                } catch (t) {
                    e = {
        ...
        R = function(e) {
            ...
            return function(e, t) {
            ...
            }(l, e), l.prototype.collectExample = function(e, r) {
                return a(this, void 0, void 0, function() {
                    var n, s, o, l, d = this;
                    return i(this, function(p) {
                        ...
                        return null != r.durationSec ? (t.util.assert(r.durationSec > 0, function() {
                        ...
                        }), s = this.parameters.fftSize / this.parameters.sampleRateHz, n = Math.ceil(r.durationSec / s)) : null != r.durationMultiplier ? (t.util.assert(r.durationMultiplier >= 1, function() {
                        ...
                        }), o = this.parameters.fftSize / this.parameters.sampleRateHz, l = o * n, this.streaming = !0, [2, new Promise(function(s) {
                                ...
                                spectrogramCallback: function(n, o) {
                                    return a(d, void 0, void 0, function() {
                                        ...
                                        return i(this, function(i) {
                                            switch (i.label) {
                                                case 0:
                                                    return null != r.onSnippet ? [3, 7] : (a = c(n), h = (l = this.dataset).addExample, d = {
                                                        label: e
                                                    }, p = {}, [4, a.data()]);
                                                case 1:
                                                    return d.spectrogram = (p.data = i.sent(), p.frameSize = this.nonBatchInputShape[1], p), r.includeRawAudio ? (w = {}, [4, o.data()]) : [3, 3];
                                                case 2:
                                                ...
                                                case 5:
                                                    return i.sent(), this.streaming = !1, this.collateTransferWords(), x = s, S = {}, [4, n.data()];
                                                case 6:
                                                ...
                                                case 8:
                                                    ...
                                                    return F = v - T - 1, v = T + 1, M = E.slice(E.length - F, E.length), y.push(M), null != r.onSnippet && r.onSnippet({
                                                        data: M,
                                                ...
                                                case 11:
                                                    R = void 0, i.label = 12;
                                                case 12:
                                                    L.apply(I, [(A.rawAudio = R, A)]), s(D), i.label = 13;
                                                case 13:
                                                    return [2, !1]
                                            }
                                        })
                            ...
                            }), d.audioDataExtractor.start(r.audioTrackConstraints)
                        })]
                    })
                })
            ...
            }, l.prototype.collectTransferDataAsTfDataset = function(e, t, r, a) {
                void 0 === t && (t = .15), void 0 === r && (r = 32);
                var i = this.nonBatchInputShape[0];
                e = e || .25;
                var s = Math.round(e * i);
                return this.dataset.getData(null, n({
                    numFrames: i,
                    hopFrames: s,
                    getDataset: !0,
                    datasetBatchSize: r,
                        ...
                        switch (a.label) {
                            case 0:
                                return t.util.assert(null != this.words && this.words.length > 0, function() {
                                    ...
                                    metrics: ["acc"]
                                }), r = null == e.fitDatasetDurationMillisThreshold ? 6e4 : e.fitDatasetDurationMillisThreshold, this.dataset.durationMillis() > r ? (console.log("Detected large dataset: total duration = " + this.dataset.durationMillis() + " ms > " + r + " ms. Training transfer model using fitDataset() instead of fit()"), [4, this.trainOnDataset(e)]) : [3, 2];
                            case 1:
                                return [2, a.sent()];
                            case 2:
                ...
                return a(this, void 0, void 0, function() {
                    var r, n, a, s, l, u, c, h, d;
                    return i(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return t.util.assert(e.epochs > 0, function() {
                                    return "Invalid config.epochs"
                                }), r = null == e.batchSize ? 32 : e.batchSize, n = e.windowHopRatio || .25, a = o(this.collectTransferDataAsTfDataset(n, e.validationSplit, r, {
                ...
                return a(this, void 0, void 0, function() {
                    var r, n, a, s, o, l, u, c, h, d;
                    return i(this, function(i) {
                        switch (i.label) {
                            case 0:
                                r = e.windowHopRatio || .25, n = this.collectTransferDataAsTensors(r, {
                                    augmentByMixingNoiseRatio: e.augmentByMixingNoiseRatio
                                }), a = n.xs, s = n.ys, console.log("Training data: xs.shape = " + a.shape + ", ys.shape = " + s.shape), i.label = 1;
                            case 1:
                                return i.trys.push([1, , 6, 7]), null != e.validationSplit ? (c = function(e, r, n) {
            ...
            }, l.prototype.fineTuningUsingTfDatasets = function(e, t, r) {
                return a(this, void 0, void 0, function() {
                    var n, a, s;
                    return i(this, function(i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return s = i.sent(), this.secondLastBaseDenseLayer.trainable = n, [2, s]
                        }
                    })
                })
            }, l.prototype.fineTuningUsingTensors = function(e, t, r, n) {
                return a(this, void 0, void 0, function() {
                    var a, s, o;
                    return i(this, function(i) {
                        switch (i.label) {
                ...
                return a(this, void 0, void 0, function() {
                    var t, r, n;
                    return i(this, function(a) {
                        return t = null != e, e = e || O(this.name), t || (r = L.localStorage.getItem(D), (n = null == r ? {} : JSON.parse(r))[this.name] = this.getMetadata(), L.localStorage.setItem(D, JSON.stringify(n))), console.log("Saving model to " + e), [2, this.model.save(e)]
                    })
                })
                ...
                return a(this, void 0, void 0, function() {
                    ...
                    return i(this, function(i) {
                        switch (i.label) {
                            case 0:
                                if (r = null != e, e = e || O(this.name), !r) {
                                    if (null == (n = JSON.parse(L.localStorage.getItem(D))) || null == n[this.name]) throw new Error("Cannot find metadata for transfer model named " + this.name + '"');
    ...
    e.create = function(e, r, n, a) {
        if (t.util.assert(null == n && null == a || null != n && null != a, function() {
                ...
                return "vocabulary name must be null or undefined when modelURL is provided."
            }), "BROWSER_FFT" === e) return new A(r, n, a);
        ...
        return a(this, void 0, void 0, function() {
            ...
            return i(this, function(n) {
                switch (n.label) {
                    case 0:
                        return null == (r = JSON.parse(L.localStorage.getItem(D))) && (r = {}), null != r[e] && delete r[e], L.localStorage.setItem(D, JSON.stringify(r)), [4, t.io.removeModel(O(e))];
                    case 1:
                        return n.sent(), [2]
                }
            })
        ...
        return a(this, void 0, void 0, function() {
            ...
            return i(this, function(a) {
                switch (a.label) {
                    ...
                    case 1:
                        for (n in e = a.sent(), r = [], e) n.startsWith(I) && r.push(n.slice(I.length));
                        return [2, r]
                }
            })
        })
